...
const SimilarExercises = ({ targetMuscleExercises, equipmentExercises }) => (
    ...
    <Typography sx={{ fontSize: { lg: '44px', xs: '25px' }, ml: '20px' }} fontWeight={700} color="white" mb="33px">
      Similar <span style={{ color: 'white', textTransform: 'capitalize' }}>Target Muscle</span> exercises
    </Typography>
    ...
    <Typography sx={{ fontSize: { lg: '44px', xs: '25px' }, ml: '20px', mt: { lg: '100px', xs: '60px' } }} fontWeight={700} color="white" mb="33px">
      Similar <span style={{ color: 'white', textTransform: 'capitalize' }}>Equipment</span> exercises
    </Typography>
    <Stack direction="row" sx={{ p: 2, position: 'relative' }}>
